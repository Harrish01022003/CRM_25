...
public class AccountPage extends ProjectSpecificMethods {
	...
	public AccountPage searchAccountName(String accountName) {
		clearAndType(locateElement(Locators.XPATH, "//input[@name='Website']"), accountName);
	...
	public AccountPage enterSearchAccountName(String search) {
	...
	public AccountPage clickDelete() {
		...
		reportStep("Delete is clicked successfully", "pass");
		return this;
	}

	public AccountPage clickOnDeletePopup() {
	...
	public AccountPage enterUpdatedName(String uName) {
		...
		reportStep(uName + "Work Type Group Name entered successfully", "pass");
		return this;
	}
